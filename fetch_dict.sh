...
# get german wordlist
curl -o- $german_url | iconv -f utf8 -t ascii//TRANSLIT | tr A-Z a-z | tr -d "-" > $dict_dir/$german_filename

# get french wordlist
curl -o- $french_url | iconv -f utf8 -t ascii//TRANSLIT | tr A-Z a-z | tr -d "-" > $dict_dir/$french_filename

# get english wordlist
curl -o- $english_url | iconv -f utf8 -t ascii//TRANSLIT | tr A-Z a-z | tr -d "-" > $dict_dir/$english_filename
